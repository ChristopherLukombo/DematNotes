...
describe('Service Tests', () => {
    ...
    describe('InscriptionModuleMySuffix Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(InscriptionModuleMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/inscription-modules';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return InscriptionModuleMySuffix', () => {
