...
describe('Service Tests', () => {
    ...
    describe('DelayStudentMySuffix Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(DelayStudentMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/delay-students';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return DelayStudentMySuffix', () => {
