...
public interface AbsenceRepository extends JpaRepository<Absence, Long> {
    ...
    @Query("select absence from Absence absence left join fetch absence.students where absence.startDate>=:periodDate")
    List<Absence> findAllAbsencesByPeriod(@Param("periodDate") ZonedDateTime periodDate);
