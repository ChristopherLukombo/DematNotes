...
import { InterventionDialogComponent } from '../../../../../../main/webapp/app/entities/intervention/intervention-dialog.component';
...
describe('Component Tests', () => {
    ...
    describe('Intervention Management Dialog Component', () => {
        let comp: InterventionDialogComponent;
        ...
        beforeEach(async(() => {
            ...
            .overrideTemplate(InterventionDialogComponent, '')
            .compileComponents();
        }));
