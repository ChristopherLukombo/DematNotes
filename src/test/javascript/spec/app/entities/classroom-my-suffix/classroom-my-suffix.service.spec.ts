...
describe('Service Tests', () => {
    ...
    describe('ClassroomMySuffix Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(ClassroomMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/classrooms';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return ClassroomMySuffix', () => {
