...
import org.csid.domain.Course;
import org.csid.repository.CourseRepository;
import org.csid.service.CourseService;
import org.csid.service.dto.CourseDTO;
import org.csid.service.mapper.CourseMapper;
...
public class CourseResourceIntTest {
    ...
    public void createCourse() throws Exception {
        ...
        assertThat(testCourse.getEntitled()).isEqualTo(DEFAULT_ENTITLED);
    ...
    public void updateCourse() throws Exception {
        ...
        Course testCourse = courseList.get(courseList.size() - 1);
        assertThat(testCourse.getEntitled()).isEqualTo(UPDATED_ENTITLED);
