...
describe('Service Tests', () => {
    ...
    describe('DocumentMySuffix Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(DocumentMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/documents';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return DocumentMySuffix', () => {
