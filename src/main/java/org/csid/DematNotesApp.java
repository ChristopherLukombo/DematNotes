...
import org.csid.config.ApplicationProperties;
import org.csid.config.DefaultProfileUtil;
...
public class DematNotesApp {
    ...
    public DematNotesApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes DematNotes.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(DematNotesApp.class);
