...
describe('Service Tests', () => {
    ...
    describe('ManagerMySuffix Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(ManagerMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/managers';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return ManagerMySuffix', () => {
