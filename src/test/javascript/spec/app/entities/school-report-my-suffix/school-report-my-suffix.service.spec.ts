...
describe('Service Tests', () => {
    ...
    describe('SchoolReportMySuffix Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(SchoolReportMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/school-reports';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return SchoolReportMySuffix', () => {
