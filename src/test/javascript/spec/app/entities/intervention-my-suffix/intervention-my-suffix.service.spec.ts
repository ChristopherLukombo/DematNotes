...
describe('Service Tests', () => {
    ...
    describe('InterventionMySuffix Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(InterventionMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/interventions';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return InterventionMySuffix', () => {
