...
public class DocumentResourceIntTest {
    ...
    public void createDocument() throws Exception {
        ...
        assertThat(testDocument.getEntitled()).isEqualTo(DEFAULT_ENTITLED);
        assertThat(testDocument.getType()).isEqualTo(DEFAULT_TYPE);
        assertThat(testDocument.isVisible()).isEqualTo(DEFAULT_VISIBLE);
    ...
    public void updateDocument() throws Exception {
        ...
        Document testDocument = documentList.get(documentList.size() - 1);
        assertThat(testDocument.getEntitled()).isEqualTo(UPDATED_ENTITLED);
        assertThat(testDocument.getType()).isEqualTo(UPDATED_TYPE);
        assertThat(testDocument.isVisible()).isEqualTo(UPDATED_VISIBLE);
